<?php
    ...
    $kkf = array_slice($keyses, $_POST['last_nm'], 8);
    ...
    foreach($kkf as $k){
        ...
        $result .= '
            ...
            $result .= '</div>
                        <div class="big_photo_gallery_item_portfolio" act-big="0" style="background: url(/img/case_photo/'.$gallery_item[0].'.jpg)no-repeat center;background-size: cover;" id="big_photo_gallery_item_portfolio'.$gg.'">
